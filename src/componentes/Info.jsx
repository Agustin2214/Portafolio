    ...
    return (
        <div className={style.contenedor}>
            ...
            <div className={style.info}>
             ...
             <div>  <img  className={style.imagen}src={bootstrap} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>BOOSTRAP</p></div>
             <div className={style.none}><p>-- --</p> </div>
             <div>  <img className={style.imagen} src={redux} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>REDUX</p></div>
             <div className={style.none}><p>-- --</p> </div>
             <div>  <img className={style.imagen} src={express} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>EXPRESS</p></div>
             <div className={style.none}><p>-- --</p> </div>
             <div> <img className={style.imagen}src={git} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>GIT</p></div> 
             <div className={style.none}><p>-- --</p> </div>
             <div>  <img className={style.imagen} src={html5} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>HTML5</p></div>
             <div className={style.none}><p>-- --</p> </div>
             <div> <img className={style.imagen} src={javascript} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>JAVASCRIPT</p></div> 
             <div className={style.none}><p>-- --</p> </div>
             </div>
             <div className={style.row}>
             <div> <img className={style.imagen} src={nodedotjs} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>NODEJS</p></div>
             <div className={style.none}><p>-- --</p> </div>
             <div>  <img className={style.imagen} src={postgresql} width={100} height={100} alt="" /><br /><br /><p className={style.ptxt}>POSTGRSQL</p></div>
             <div className={style.none}><p>-- --</p> </div>
